...
export const metadata: Metadata = {
  ...
  description:
    'Our commitment to security, privacy, and compliance. Learn how we protect your data and ensure regulatory compliance.',
};
...
export default function TrustPage({ params }: TrustPageProps) {
  ...
  return (
    <>
      <SeoHead
        title={t(
          'ศูนย์ความปลอดภัยและความน่าเชื่อถือ - CerebraTechAI',
            ...
            <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
              {securityPillars.map(pillar => {
                ...
                return (
                  <Card
                    key={pillar.title}
                    className="border border-hairline bg-surface/80 backdrop-blur"
                  >
              ...
              <CardContent className="p-8 text-center">
                ...
                <div className="space-y-2 text-sm">
                  <p className="text-text-muted">
                    ...
                    <a
                      href="mailto:security@cerebratechai.com"
                  ...
                  <p className="text-text-muted">
                    ...
                    <a
                      href="mailto:compliance@cerebratechai.com"
                      className="text-primary hover:underline"
                    >
