  ...
  const mlSolutions = [
    {
      ...
      description:
        'Reduce equipment downtime by 40% with AI-powered predictive maintenance systems.',
      features: [
        'Anomaly detection',
        'Failure prediction',
    ...
    },
    {
      ...
      description:
        'Accurate demand prediction for inventory optimization and supply chain efficiency.',
      features: [
    ...
    },
    {
      ...
      description:
        'Identify at-risk customers and implement retention strategies proactively.',
      features: [
        'Behavioral analysis',
        'Risk scoring',
    ...
    },
    {
      ...
      description:
        'Real-time fraud detection with 99.5% accuracy and minimal false positives.',
      features: [
    ...
    },
    {
      ...
      description:
        'Dynamic pricing strategies to maximize revenue while maintaining competitiveness.',
      features: [
        'Market analysis',
        'Competitor tracking',
        'Demand elasticity',
    ...
    },
    {
      ...
      description:
        'Automated quality inspection with 95% accuracy improvement over manual processes.',
      features: [
        'Defect detection',
        'Quality scoring',
  ...
  const capabilities = [
    {
      ...
      description:
        'Deep learning, ensemble methods, and custom algorithm development for complex business problems.',
    },
    {
      icon: BarChart3,
      title: 'Data Analytics',
      description:
        'Comprehensive data analysis, feature engineering, and statistical modeling for actionable insights.',
    },
    {
      icon: Zap,
      title: 'Real-time Processing',
      description:
        'Stream processing and real-time model inference for immediate decision making.',
    },
    {
      icon: Target,
      title: 'Model Optimization',
      description:
        'Hyperparameter tuning, model compression, and performance optimization for production deployment.',
    },
    {
      icon: Users,
      title: 'MLOps Integration',
      description:
        'Complete MLOps pipeline with CI/CD, monitoring, and automated retraining workflows.',
    },
    {
      icon: Award,
      title: 'Production Ready',
      description:
        'Enterprise-grade ML systems with scalability, reliability, and comprehensive monitoring.',
    },
  ];
  ...
  return (
    <>
      <SeoHead
        title={
          isThai
            ? 'Machine Learning Solutions - AI ที่เรียนรู้จากข้อมูล'
            : 'Machine Learning Solutions - AI That Learns from Data'
        }
        description={
          isThai
                ...
                facts={[
                  ...
                  },
                  {
                    label: isThai
                      ...
                      : 'Minimum Data Required',
                    value: isThai
                      ? 'เริ่มได้จากข้อมูลย้อนหลัง 3-12 เดือน + นิยาม KPI'
                      : '3–12 months of historical data + KPI definition',
                  },
                  {
                  ...
                  },
                  {
                    ...
                    value:
                      'Accuracy, precision/recall, latency, business KPI uplift',
                  },
                  {
                    label: isThai ? 'Timeline' : 'Timeline',
                    value: isThai
                      ? 'POC: 6-10 สัปดาห์ | Pilot: 8-14 สัปดาห์'
                      : 'POC: 6-10 weeks | Pilot: 8-14 weeks',
                  },
                  {
                    label: isThai ? 'Pricing' : 'Pricing',
                    value: isThai
                      ? 'เริ่มจาก Kickstart/POC เพื่อประเมินขอบเขต'
                      : 'Start with Kickstart/POC to scope and estimate',
                  },
                ]}
                locale={schemaLocale}
              />
          ...
          <div className="container mx-auto px-6">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-text-muted max-w-3xl mx-auto">
                From data preprocessing to model deployment, we provide
                end-to-end machine learning solutions tailored to your business
                needs.
              </p>
            </div>
        ...
        <section className="py-20 bg-surface/50">
          <div className="container mx-auto px-6">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-text-muted max-w-3xl mx-auto">
                Ready-to-deploy ML solutions across various industries and use
                cases.
              </p>
            </div>
            ...
            <Card className="border border-hairline bg-gradient-to-r from-primary/10 via-secondary/10 to-accent/10">
              <CardContent className="p-12 text-center">
                ...
                <p className="text-xl text-text-muted mb-8 max-w-2xl mx-auto">
                  Let our ML experts help you identify opportunities, build
                  custom models, and deploy production-ready solutions that
