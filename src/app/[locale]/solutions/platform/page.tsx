  ...
  const platformSolutions = [
    {
      ...
      description:
        'Transform legacy systems into modern, scalable AI platforms with cloud-native architecture.',
      features: [
    ...
    },
    {
      ...
      description:
        'Comprehensive data platform for storage, processing, and analytics at scale.',
      features: [
        'Data ingestion',
        'ETL pipelines',
        'Data governance',
    ...
    },
    {
      ...
      description:
        'End-to-end MLOps platform for model development, deployment, and monitoring.',
      features: [
        'Model versioning',
        'CI/CD pipelines',
        'Monitoring',
    ...
    },
    {
      ...
      description:
        'Centralized API management platform with security, monitoring, and analytics.',
      features: [
        'API gateway',
        'Rate limiting',
        'Authentication',
    ...
    },
    {
      ...
      description:
        'Real-time event processing platform for high-throughput data streams.',
      features: [
        'Event ingestion',
        'Stream processing',
        'Real-time analytics',
    ...
    },
    {
      ...
      description:
        'Scalable multi-tenant platform architecture for SaaS applications.',
      features: [
        'Tenant isolation',
        'Resource management',
        'Billing integration',
  ...
  const capabilities = [
    {
      ...
      description:
        'Design and implement scalable cloud-native architectures using modern cloud platforms.',
    },
    {
      icon: Cloud,
      title: 'Microservices Design',
      description:
        'Build resilient microservices architectures with service mesh and container orchestration.',
    },
    {
      icon: Zap,
      title: 'Performance Optimization',
      description:
        'Optimize platform performance with caching, load balancing, and resource management.',
    },
    {
      icon: Target,
      title: 'Security & Compliance',
      description:
        'Implement enterprise-grade security with authentication, authorization, and compliance frameworks.',
    },
    {
      icon: Users,
      title: 'Scalability & Reliability',
      description:
        'Design platforms that scale horizontally and maintain high availability and reliability.',
    },
    {
      icon: Award,
      title: 'DevOps Integration',
      description:
        'Integrate DevOps practices with CI/CD pipelines, monitoring, and automated deployment.',
    },
  ];
  ...
  return (
    <>
      <SeoHead
        title={
          isThai
            ? 'Platform Solutions - Edge to Cloud Infrastructure'
            : 'Platform Solutions - Edge to Cloud Infrastructure'
        }
        description={
          isThai
                ...
                facts={[
                  {
                    ...
                    value: isThai
                      ? 'ทีมที่ต้องการ modernize ระบบ/infra และรองรับ scale'
                      : 'Teams modernizing infra to scale reliably',
                  },
                  {
                    label: isThai ? 'Deliverables' : 'Deliverables',
                    value: isThai
                      ? 'Blueprint + IaC + CI/CD + Monitoring + Runbooks'
                      : 'Blueprints + IaC + CI/CD + monitoring + runbooks',
                  },
                  {
                  ...
                  },
                  {
                    ...
                    value: isThai
                      ? 'SSO/RBAC, encryption, audit logs, compliance-ready'
                      : 'SSO/RBAC, encryption, audit logs, compliance-ready',
                  },
                  {
                    label: isThai ? 'Timeline' : 'Timeline',
                    value: isThai
                      ? '8-24 สัปดาห์ (ขึ้นกับขอบเขต)'
                      : '8-24 weeks (scope-dependent)',
                  },
                  {
                    label: isThai ? 'Pricing' : 'Pricing',
                    value: isThai
                      ? 'เริ่มจาก discovery เพื่อประเมินสภาพระบบเดิม'
                      : 'Start with discovery to assess current stack',
                  },
                ]}
                locale={schemaLocale}
              />
          ...
          <div className="container mx-auto px-6">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-text-muted max-w-3xl mx-auto">
                From architecture design to deployment, we provide comprehensive
                platform solutions for any scale.
              </p>
            </div>
        ...
        <section className="py-20 bg-surface/50">
          <div className="container mx-auto px-6">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-text-muted max-w-3xl mx-auto">
                Ready-to-deploy platform solutions for modern, scalable
                applications.
              </p>
            </div>
            ...
            <Card className="border border-hairline bg-gradient-to-r from-primary/10 via-secondary/10 to-accent/10">
              <CardContent className="p-12 text-center">
                ...
                <p className="text-xl text-text-muted mb-8 max-w-2xl mx-auto">
                  Let our platform experts help you design and implement
                  scalable, modern platforms that support your business growth
                  and innovation.
                </p>
