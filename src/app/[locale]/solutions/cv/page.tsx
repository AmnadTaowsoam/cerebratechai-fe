  ...
  const cvSolutions = [
    {
      ...
      description:
        'Automated visual inspection with 99.2% accuracy for manufacturing quality control.',
      features: [
        'Defect detection',
        'Surface inspection',
    ...
    },
    {
      ...
      description:
        'Intelligent document processing with multi-language support and high accuracy.',
      features: [
        'Text extraction',
        'Layout analysis',
        'Data validation',
    ...
    },
    {
      ...
      description:
        'Customer behavior analysis and inventory management through computer vision.',
      features: [
        'People counting',
        'Heat mapping',
        'Shelf monitoring',
    ...
    },
    {
      ...
      description:
        'AI-powered medical imaging for faster and more accurate diagnosis.',
      features: [
        'Image segmentation',
        'Anomaly detection',
        'Diagnostic support',
    ...
    },
    {
      ...
      description:
        'Intelligent surveillance system with real-time threat detection and analysis.',
      features: [
        'Object detection',
        'Face recognition',
        'Behavior analysis',
    ...
    },
    {
      ...
      description:
        'Computer vision systems for autonomous vehicles and advanced driver assistance.',
      features: [
        'Object detection',
        'Lane detection',
  ...
  const capabilities = [
    {
      ...
      description:
        'Advanced image classification, object detection, and scene understanding using state-of-the-art deep learning models.',
    },
    {
      icon: Camera,
      title: 'Real-time Processing',
      description:
        'High-performance image processing pipelines optimized for real-time applications and edge deployment.',
    },
    {
      icon: Target,
      title: 'Custom Model Training',
      description:
        'Specialized model training for domain-specific applications with custom datasets and requirements.',
    },
    {
      icon: Zap,
      title: 'Edge Optimization',
      description:
        'Model optimization for edge devices with quantization, pruning, and hardware-specific acceleration.',
    },
    {
      icon: Users,
      title: 'Multi-modal Analysis',
      description:
        'Integration of visual data with other sensor inputs for comprehensive situational awareness.',
    },
    {
      icon: Award,
      title: 'Production Deployment',
      description:
        'Scalable deployment solutions with monitoring, versioning, and continuous improvement capabilities.',
    },
  ];
  ...
  return (
    <>
      <SeoHead
        title={
          isThai
            ? 'Computer Vision Solutions - AI ที่เห็นและเข้าใจภาพ'
            : 'Computer Vision Solutions - AI That Sees and Understands'
        }
        description={
          isThai
                  ...
                  facts={[
                    {
                      ...
                      value: isThai
                        ? 'การตรวจสอบคุณภาพ, การจัดการ, การวิเคราะห์เอกสาร, การเฝ็ก'
                        : 'Quality inspection, document processing, retail analytics, medical imaging, security surveillance',
                    },
                    {
                      label: isThai ? 'ข้อมูลขั้นต่ำ' : 'Minimum Data Required',
                      value: isThai
                        ? 'ภาพตัวอย่าง 1-10 แหล่ง + เป้าหมายการตรวจ'
                        : 'Sample images (10-100) + clear detection objectives',
                    },
                    {
                      label: isThai ? 'สิ่งที่ได้รับ' : 'Deliverables',
                      value: isThai
                        ? 'โมเดลตรวจจัด, pipeline การประมวณภาพ, แดชบอร์ตรวจเวลาจริง, ระบบแจ้งเตือน'
                        : 'Vision model, image processing pipeline, real-time alert system, monitoring dashboard',
                    },
                    {
                      label: isThai
                        ? 'KPI และการประเมินผล'
                        : 'KPI & Evaluation',
                      value: isThai
                        ? 'ความแม่นยำ, precision, recall, F1-score, latency'
                        : 'Accuracy, precision, recall, F1-score, latency',
                    },
                    {
                      label: isThai ? 'ระยะเวลา' : 'Timeline',
                      value: isThai
                        ? 'POC: 8-12 สัปดาห์ | Pilot: 8-20 สัปดาห์'
                        : 'POC: 8-12 weeks | Pilot: 8-20 weeks',
                    },
                    {
                      label: isThai
                        ? 'ตัวเลือกการใช้งาน'
                    ...
                    },
                    {
                      ...
                      value: isThai
                        ? 'API integration, dashboard, SSO/RBAC'
                        : 'API integration, dashboard, SSO/RBAC',
                    },
                    {
          ...
          <div className="container mx-auto px-6">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-text-muted max-w-3xl mx-auto">
                From image processing to real-time analysis, we provide
                comprehensive computer vision solutions for any industry.
              </p>
            </div>
        ...
        <section className="py-20 bg-surface/50">
          <div className="container mx-auto px-6">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-text-muted max-w-3xl mx-auto">
                Ready-to-deploy computer vision solutions across various
            ...
            <Card className="border border-hairline bg-gradient-to-r from-primary/10 via-secondary/10 to-accent/10">
              <CardContent className="p-12 text-center">
                ...
                <p className="text-xl text-text-muted mb-8 max-w-2xl mx-auto">
                  Let our computer vision experts help you harness the power of
                  visual AI to automate processes, improve quality, and gain
                  valuable insights from your visual data.
                </p>
