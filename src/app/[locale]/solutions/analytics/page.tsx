...
export default function AnalyticsPage() {
  ...
  const analyticsSolutions = [
    {
      ...
      description: 'Comprehensive BI platform with interactive dashboards and advanced analytics.',
      features: ['Interactive dashboards', 'Data visualization', 'Report automation', 'Mobile access'],
      industry: 'Enterprise',
    ...
    },
    {
      ...
      description: 'Real-time operational insights for process optimization and efficiency.',
      features: ['Process monitoring', 'Performance metrics', 'Anomaly detection', 'Optimization recommendations'],
    ...
    },
    {
      ...
      description: 'Advanced financial analysis with risk assessment and forecasting.',
      features: ['Risk analysis', 'Financial forecasting', 'Compliance reporting', 'Fraud detection'],
      industry: 'Finance',
    ...
    },
    {
      ...
      description: 'Comprehensive marketing analytics with attribution and ROI measurement.',
      features: ['Campaign analysis', 'Attribution modeling', 'ROI measurement', 'A/B testing'],
      industry: 'Marketing',
      timeline: '6-10 weeks',
      price: '฿750,000'
    },
    {
      ...
      description: 'End-to-end supply chain visibility with predictive analytics.',
  ...
  const capabilities = [
    {
      ...
      description: 'Create compelling visualizations and interactive dashboards for better data understanding.'
    },
    {
      icon: TrendingUp,
      title: 'Predictive Analytics',
      description: 'Build predictive models for forecasting, trend analysis, and future planning.'
    },
    {
      icon: Zap,
    ...
    },
    {
      ...
      description: 'Implement machine learning and statistical models for deeper insights and automation.'
    },
    {
      icon: Users,
      title: 'Self-service Analytics',
      description: 'Enable business users to explore data and create reports without technical expertise.'
    },
    {
      icon: Award,
      title: 'Data Governance',
      description: 'Implement data quality, security, and compliance frameworks for reliable analytics.'
    }
  ];
  ...
  return (
    <>
      <SeoHead
        title={isThai ? 'Analytics Solutions - วิเคราะห์ข้อมูลด้วย AI' : 'Analytics Solutions - Data Analysis with AI'}
        description={isThai 
        ...
        keywords={isThai 
          ? ['Analytics', 'BI', 'Data Analytics', 'Dashboard', 'วิเคราะห์ข้อมูล']
          : ['Analytics', 'Business Intelligence', 'Data Analytics', 'Dashboard', 'Reporting']
        }
        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-text-muted max-w-3xl mx-auto">
              From data visualization to predictive modeling, we provide comprehensive analytics solutions for any business need.
            </p>
          </div>
      ...
      <section className="py-20 bg-surface/50">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-text-muted max-w-3xl mx-auto">
              Ready-to-deploy analytics solutions across various industries and use cases.
            </p>
          </div>
          ...
          <Card className="border border-hairline bg-gradient-to-r from-primary/10 via-secondary/10 to-accent/10">
            <CardContent className="p-12 text-center">
              ...
              <p className="text-xl text-text-muted mb-8 max-w-2xl mx-auto">
                Let our analytics experts help you build comprehensive data solutions that drive informed decision making and business growth.
              </p>
