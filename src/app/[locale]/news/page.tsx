...
export default function NewsPage() {
  ...
  const newsItems = [
    {
      ...
      title:
        'CerebraTechAI Secures Series A Funding to Accelerate AI Innovation',
      excerpt:
        'Leading AI studio raises $5M to expand team and accelerate development of enterprise AI solutions across Southeast Asia.',
      date: '2024-01-20',
    ...
    },
    {
      ...
      title:
        'CerebraTechAI Partners with Leading Manufacturing Company for AI Implementation',
      excerpt:
        'Strategic partnership to implement computer vision solutions for quality inspection, reducing defects by 60% in production lines.',
      date: '2024-01-15',
    ...
    },
    {
      ...
      title:
        'CerebraTechAI Wins "Best AI Startup" at Southeast Asia Tech Awards',
      excerpt:
        'Recognition for innovative AI solutions and exceptional client delivery in the competitive Southeast Asian market.',
      date: '2024-01-10',
      category: 'Awards',
      type: 'achievement',
      featured: false,
    ...
    },
    {
      ...
      excerpt:
        'Welcoming Dr. Sarah Chen as Chief AI Officer and James Rodriguez as Head of Engineering to strengthen our technical leadership.',
      date: '2024-01-05',
      category: 'Company News',
      type: 'announcement',
      featured: false,
    ...
    },
    {
      ...
      excerpt:
        'New initiative focuses on responsible AI development and deployment, ensuring ethical considerations in all client projects.',
      date: '2023-12-28',
    ...
    },
    {
      ...
      title:
        'CerebraTechAI Research Team Publishes Paper on Edge AI Optimization',
      excerpt:
        'Technical paper on optimizing AI models for edge deployment published in leading AI research journal.',
      date: '2023-12-20',
      category: 'Research',
      type: 'publication',
      featured: false,
  ...
  const mediaCoverage = [
    {
      outlet: 'TechCrunch',
      title:
        'Southeast Asian AI Startup Raises $5M to Scale Enterprise Solutions',
      date: '2024-01-20',
    ...
    },
    {
      ...
      title:
        "Rising AI Stars: CerebraTechAI's Journey from Startup to Industry Leader",
      date: '2023-12-15',
  ...
  const categories = [
    { name: 'All', slug: 'all', count: newsItems.length },
    {
      name: 'Company News',
      slug: 'company',
      count: newsItems.filter(item => item.category === 'Company News').length,
    },
    {
      name: 'Partnership',
      slug: 'partnership',
      count: newsItems.filter(item => item.category === 'Partnership').length,
    },
    {
      name: 'Awards',
      slug: 'awards',
      count: newsItems.filter(item => item.category === 'Awards').length,
    },
    {
      name: 'Research',
      slug: 'research',
      count: newsItems.filter(item => item.category === 'Research').length,
    },
  ];
    ...
    <div className="bg-bg">
      ...
      <MagicHero
        ...
        metrics={[
          {
            value: '6',
            label: locale.startsWith('th') ? 'ข่าวล่าสุด' : 'Recent News',
          },
          {
            value: '4',
            label: locale.startsWith('th') ? 'การรายงานข่าว' : 'Media Coverage',
          },
          {
            value: '98%',
            label: locale.startsWith('th')
              ? 'ความพึงพอใจของลูกค้า'
              : 'Client Satisfaction',
            disclaimer: locale.startsWith('th')
              ? '* จากการสำรวจประจำปี 2023-2025'
              : '* Based on annual surveys 2023-2025',
          },
        ]}
      />
