...
export async function generateMetadata({
  ...
  return {
    title: isThai
      ? 'เกี่ยวกับเรา - CerebraTechAI AI Studio'
      : 'About Us - CerebraTechAI AI Studio',
    description: isThai
      ? 'ทีม AI ของ CerebraTechAI ในกรุงเทพฯ เชี่ยวชาญการพัฒนาโซลูชัน AI สำหรับธุรกิจ'
...
export default async function AboutPage({
  ...
  const teamMembers = [
    {
      ...
      bio: isThai
        ? 'ผู้เชี่ยวชาญด้าน AI และ Machine Learning มีประสบการณ์กว่า 10 ปีในการพัฒนาโซลูชัน AI สำหรับธุรกิจ'
        : 'AI and Machine Learning expert with 10+ years of experience developing AI solutions for businesses.',
    ...
    },
    {
      ...
      bio: isThai
        ? 'ผู้เชี่ยวชาญด้านสถาปัตยกรรมซอฟต์แวร์ มีประสบการณ์ในการพัฒนาระบบ Cloud และ Edge Computing'
        : 'Software architecture expert with experience in developing Cloud and Edge Computing systems.',
    ...
    },
    {
      ...
      bio: isThai
        ? 'ผู้เชี่ยวชาญด้าน Data Science และ Analytics มีประสบการณ์ในการพัฒนาโมเดล Machine Learning'
        : 'Data Science and Analytics expert with experience in developing Machine Learning models.',
    ...
    },
    {
      ...
      bio: isThai
        ? 'ผู้เชี่ยวชาญด้านสถาปัตยกรรมโซลูชัน มีประสบการณ์ในการออกแบบและพัฒนาโซลูชัน AI'
        : 'Solutions architecture expert with experience in designing and developing AI solutions.',
  ...
  const values = [
    ...
    },
    {
      ...
      description: isThai
        ? 'เราให้ความสำคัญกับความโปร่งใสและความน่าเชื่อถือในทุกโครงการ'
        : 'We prioritize transparency and trustworthiness in every project.',
    },
    {
      icon: Zap,
      title: isThai ? 'ผลกระทบ' : 'Impact',
      description: isThai
        ? 'เราเชื่อว่า AI ควรช่วยแก้ปัญหาในโลกจริงและสร้างคุณค่าที่มีความหมาย'
        : 'We believe AI should solve real-world problems and create meaningful value.',
    },
    {
      icon: UserCheck,
      title: isThai ? 'การทำงานร่วมกัน' : 'Collaboration',
      description: isThai
        ? 'เราทำงานร่วมกับทีมของคุณ ไม่ใช่แค่ทำงานให้ แต่มั่นใจที่จะถ่ายทอดความและความสำเร็จที่ยั่งยืนยาว'
        : 'We work alongside your team, not just for you, ensuring knowledge transfer and sustainable success.',
    },
  ];
            ...
            <div className="grid gap-8 md:grid-cols-3">
              <Card className="border border-hairline bg-surface/80">
                <CardContent className="p-6 text-center">
                  ...
                  <h3 className="text-lg font-semibold text-text mb-2">
                    {isThai ? 'ก่อตั้ง' : 'Founded'}
                  </h3>
                  <p className="text-sm text-text-muted">
                    {isThai
                      ? 'เริ่มต้นด้วยวิสัยที่จะทำให้ AI เข้าถึงได้และใช้งานได้จริงสำหรับทุกคน'
                      : 'Started with a vision to make AI accessible and practical for everyone.'}
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="border border-hairline bg-surface/80">
                <CardContent className="p-6 text-center">
                  ...
                  <h3 className="text-lg font-semibold text-text mb-2">
                    {isThai ? 'ผลิตภัณฑ์' : 'Products'}
                  </h3>
                  <p className="text-sm text-text-muted">
                    {isThai
                      ? 'พัฒนาแอปพลิเคชันและบริการ AI ที่หลากหลาย'
                      : 'Developed diverse AI applications and services.'}
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="border border-hairline bg-surface/80">
                <CardContent className="p-6 text-center">
                  ...
                  <h3 className="text-lg font-semibold text-text mb-2">
                    {isThai ? 'ลูกค้า' : 'Clients'}
                  </h3>
                  <p className="text-sm text-text-muted">
                    {isThai
                      ? 'ให้บริการลูกค้าในหลายอุตสาหกรรม'
        ...
        <section className="py-20">
          <div className="container mx-auto px-6">
            <div className="text-center mb-16">
              <h2 className="text-3xl font-bold text-text mb-4">
                {isThai
                  ? 'บริการและโซลูชันที่เรามอบให้'
                  : 'Services & Solutions We Deliver'}
              </h2>
            ...
            <div className="mb-12">
              <h3 className="text-2xl font-bold text-text mb-6">
                {isThai ? 'โซลูชันแพลตฟอร์ม' : 'Platform Solutions'}
              </h3>
                  ...
                  <CardContent className="p-8">
                    ...
                    <div className="flex flex-wrap gap-2">
                      <span className="px-3 py-1 bg-primary/10 text-primary text-sm rounded-full">
                        {isThai ? 'จัดการพิธี' : 'Event Management'}
                      </span>
                      <span className="px-3 py-1 bg-primary/10 text-primary text-sm rounded-full">
                        {isThai ? 'วางแผน AI' : 'AI Planning'}
                      </span>
                    </div>
                  </CardContent>
                </Card>
            ...
            <div className="mb-12">
              <h3 className="text-2xl font-bold text-text mb-6">
                {isThai ? 'โซลูชัน Edge AI' : 'Edge AI Solutions'}
              </h3>
              <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
                <Card className="border border-hairline bg-surface/80 hover:shadow-xl transition-all">
                  <CardContent className="p-8">
                    ...
                    <div className="flex flex-wrap gap-2">
                      <span className="px-3 py-1 bg-accent/10 text-accent text-sm rounded-full">
                        {isThai ? 'กล้องวงจร' : 'Surveillance'}
                      </span>
                      <span className="px-3 py-1 bg-accent/10 text-accent text-sm rounded-full">
                        {isThai ? 'วิเคราะห์ภาพ' : 'Image Analysis'}
                      </span>
                    </div>
                  </CardContent>
                </Card>
                ...
                <Card className="border border-hairline bg-surface/80 hover:shadow-xl transition-all">
                  <CardContent className="p-8">
                    <h4 className="text-xl font-bold text-text mb-4">
                      {isThai
                        ? 'Edge Computer (Jetson/Raspberry Pi + LLM)'
                        : 'Edge Computer (Jetson/Raspberry Pi + LLM)'}
                    </h4>
                    <p className="text-text-muted mb-4">
                      {isThai
                    ...
                    <div className="flex flex-wrap gap-2">
                      <span className="px-3 py-1 bg-primary/10 text-primary text-sm rounded-full">
                        {isThai ? 'Edge Computing' : 'Edge Computing'}
                      </span>
                      <span className="px-3 py-1 bg-primary/10 text-primary text-sm rounded-full">
                        LLM
                      </span>
              ...
              <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
                <Card className="border border-hairline bg-surface/80 hover:shadow-xl transition-all">
                  <CardContent className="p-8">
                    <h4 className="text-xl font-bold text-text mb-4">
                      {isThai
                        ? 'ทำนายน้ำหนักด้วยกล้อง Depth'
                        : 'Depth Camera Weight Prediction'}
                    </h4>
                    <p className="text-text-muted mb-4">
                      {isThai
                    ...
                    <div className="flex flex-wrap gap-2">
                      <span className="px-3 py-1 bg-accent/10 text-accent text-sm rounded-full">
                        {isThai ? 'กล้อง Depth' : 'Depth Camera'}
                      </span>
                      <span className="px-3 py-1 bg-accent/10 text-accent text-sm rounded-full">
                        {isThai ? 'ทำนายน้ำหนัก' : 'Weight Prediction'}
                      </span>
                    </div>
                  </CardContent>
                </Card>
                ...
                <Card className="border border-hairline bg-surface/80 hover:shadow-xl transition-all">
                  <CardContent className="p-8">
                    <h4 className="text-xl font-bold text-text mb-4">
                      {isThai ? 'ระบบ OCR Dashboard' : 'OCR Dashboard System'}
                    </h4>
                    <p className="text-text-muted mb-4">
                      {isThai
                    ...
                    <div className="flex flex-wrap gap-2">
                      ...
                      <span className="px-3 py-1 bg-primary/10 text-primary text-sm rounded-full">
                        {isThai ? 'ประมวลผลเอกสาร' : 'Document Processing'}
                      </span>
                    </div>
                  </CardContent>
                </Card>
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-text font-semibold">
                        {isThai ? 'สมชัย รัตนา' : 'Somchai Rattana'}
                      </p>
                      <p className="text-sm text-text-muted">
                        {isThai
                          ? 'CEO, Thai Events Co.'
              ...
              <Card className="border border-hairline bg-surface/80">
                <CardContent className="p-8">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-text font-semibold">
                        {isThai ? 'ปรีชา โกมลพิส' : 'Preecha Komolpis'}
                      </p>
                      <p className="text-sm text-text-muted">
                        {isThai
                          ? 'CTO, Enterprise Solutions Ltd.'
                          : 'CTO, Enterprise Solutions Ltd.'}
                      </p>
                    </div>
                  </div>
              ...
              <Card className="border border-hairline bg-surface/80">
                <CardContent className="p-8">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-text font-semibold">
                        {isThai ? 'นิรัน วงภักดี' : 'Niran Wongpakdi'}
                      </p>
                      <p className="text-sm text-text-muted">
                        {isThai
                          ? 'ผู้อำนวยการ, Smart Factory Inc.'
                          : 'Operations Director, Smart Factory Inc.'}
                      </p>
                    </div>
                  </div>
                </CardContent>
          ...
          <div className="container mx-auto px-6">
            ...
            <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
              {teamMembers.map((member, index) => (
                <Card
                  key={index}
                  className="border border-hairline bg-surface/80 hover:bg-surface transition-colors hover:shadow-xl"
                >
                  <CardContent className="p-6 text-center">
