  ...
  const openPositions = [
    {
      ...
      experience: '5+ years',
      description:
        'Lead the development of production ML systems and mentor junior engineers.',
      requirements: [
    ...
    },
    {
      ...
      experience: '7+ years',
      description:
        'Design and architect AI solutions for enterprise clients across various industries.',
      requirements: [
    ...
    },
    {
      ...
      experience: '4+ years',
      description:
        'Develop predictive models and analytics solutions for real-world business problems.',
      requirements: [
    ...
    },
    {
      ...
      experience: '3+ years',
      description:
        'Build intuitive interfaces for AI applications and data visualization dashboards.',
      requirements: [
    ...
    <div className="bg-bg">
      ...
      <MagicHero
        ...
        metrics={[
          {
            value: '25+',
            label: locale.startsWith('th') ? 'สมาชิกทีม' : 'Team Members',
          },
          {
            value: '4',
            label: locale.startsWith('th') ? 'ตำแหน่งว่าง' : 'Open Positions',
          },
          {
            value: '98%',
          ...
          <div className="grid gap-8 md:grid-cols-3">
            <Card className="border border-hairline bg-surface/80">
              <CardContent className="p-6">
                <div className="mb-4">
                  <div className="flex text-primary mb-2">{'★'.repeat(5)}</div>
                  <p className="text-text-muted italic">
                    &quot;Working at CerebraTechAI has been incredible. The
                    projects are challenging, the team is supportive, and
                    I&apos;m constantly learning new technologies. The best part
                    is seeing our AI solutions make a real difference for our
                    clients.&quot;
                  </p>
                </div>
            ...
            <Card className="border border-hairline bg-surface/80">
              <CardContent className="p-6">
                <div className="mb-4">
                  <div className="flex text-primary mb-2">{'★'.repeat(5)}</div>
                  <p className="text-text-muted italic">
                    &quot;The culture here is amazing. We have the freedom to
                    experiment and innovate, while also having the support and
                    resources we need to succeed. Every day brings new
            ...
            <Card className="border border-hairline bg-surface/80">
              <CardContent className="p-6">
                <div className="mb-4">
                  <div className="flex text-primary mb-2">{'★'.repeat(5)}</div>
                  <p className="text-text-muted italic">
                    &quot;I love how we&apos;re not just building AI for the
                    sake of it - we&apos;re solving real business problems. The
                    impact we make is tangible, and that makes coming to work
                  ...
                  <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-4">
                    ...
                    <div className="flex-shrink-0 lg:ml-6">
                      <Button asChild>
                        <Link
                          href={
                            `${basePath}/contact?position=${position.id}` as any
                          }
                        >
