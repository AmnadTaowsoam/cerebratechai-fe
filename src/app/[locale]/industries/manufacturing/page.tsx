...
export async function generateMetadata({
  ...
  const t = await getTranslations({
    ...
    namespace: 'industries.manufacturing',
  });
          ...
          <div className="space-y-6">
            <div className="bg-white p-6 rounded-2xl border border-slate-200">
              ...
              <p className="text-slate-600 text-lg">
                Our AI-powered SPC platform detects anomalies in real-time,
                reducing defects by up to 40% and improving overall product
                quality.
              </p>
            </div>
            <div className="bg-white p-6 rounded-2xl border border-slate-200">
              ...
              <p className="text-slate-600 text-lg">
                We support common MES systems via API and can create custom
