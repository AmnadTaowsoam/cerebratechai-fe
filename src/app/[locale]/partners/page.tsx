...
export default function PartnersPage() {
  ...
  return (
    <div className="bg-bg">
      ...
      <MagicHero
        eyebrow={
          locale.startsWith('th') ? 'โปรแกรมพันธมิตร' : 'Partnership Program'
        }
        title={
          locale.startsWith('th')
            ? 'สร้างระบบนิเวศ AI ที่แข็งแกร่งร่วมกัน'
            : 'Building Strong AI Ecosystems Together'
        }
        description={
          locale.startsWith('th')
            ...
            {integrationPartners.map((partner, index) => (
              ...
              >
                <CardContent className="p-6 text-center">
                  ...
                  <p className="text-sm text-accent mb-2">{partner.category}</p>
                  <p className="text-sm text-text-muted mb-4">
                    {partner.description}
                  </p>
                  <Button variant="outline" size="sm" asChild>
              ...
              <CardContent className="p-6">
                <div className="mb-4">
                  ...
                  <p className="text-sm text-text-muted">
                    Partnered with Microsoft Azure to implement predictive
                    maintenance AI, reducing downtime by 60% and increasing
            ...
            <Card className="border border-hairline bg-surface/80">
              <CardContent className="p-6">
                <div className="mb-4">
                  ...
                  <p className="text-sm text-text-muted">
                    Leveraged AWS and Databricks to build real-time fraud
                    detection system, improving accuracy by 95% and reducing
            ...
            <Card className="border border-hairline bg-surface/80">
              <CardContent className="p-6">
                <div className="mb-4">
                  ...
                  <p className="text-sm text-text-muted">
                    Integrated with Salesforce and Google Cloud to create
                    personalized customer experience platform, increasing
                    customer satisfaction by 250%.
                  </p>
                </div>
                <div className="text-xs text-primary font-medium">
            ...
            {partnerProgram.map((program, index) => (
              ...
              >
                <CardContent className="p-6">
                  ...
                  <p className="text-text-muted mb-4">{program.description}</p>
