...
export const packagesMap: Record<string, PackageConfig> = {
  ...
  assurance: {
    ...
    outOfScope: ['External penetration test', 'Audit documentation pack'],
    outOfScopeTh: ['External penetration test', 'Audit documentation pack'],
    deliverables: [
  ...
  care_plan: {
    ...
    postLaunch: true,
    bullets: [
      'Shared metrics workspace',
      'Model refresh cadence',
      'On-demand enhancements',
    ],
    bulletsTh: [
      'พื้นที่ติดตามตัวชี้วัดร่วมกัน',
      'รอบการรีเฟรชโมเดล',
    ...
    tiers: [
      ...
      },
      {
        ...
        hours: 48,
        sla: '4h',
        bonus: '1 mini-sprint/quarter',
        bonusTh: '1 mini-sprint/ไตรมาส',
      },
    ],
