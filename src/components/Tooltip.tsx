...
const glossary = {
  en: {
    Canary:
      'A deployment strategy where new version is rolled out to a small subset of users first',
    'Blue-green':
      'A deployment strategy using two identical production environments',
    Guardrails:
      'Safety mechanisms to prevent AI from generating harmful or inappropriate content',
    ...
    'Edge CV':
      'Computer Vision processing at the edge (on-device) rather than in the cloud',
  ...
  th: {
    ...
    'Blue-green':
      'กลยุทธ์การปล่อยใช้งานโดยใช้สภาพแวดล้อมการผลิตสองชุดที่เหมือนกัน',
    Guardrails:
      'กลไกความปลอดภัยเพื่อป้องกัน AI จากการสร้างเนื้อหาที่เป็นอันตราย',
    ...
    'Edge CV':
      'การประมวลผล Computer Vision ที่ Edge (บนอุปกรณ์) แทนที่จะเป็นในคลาวด์',
    IoT: 'Internet of Things - เครือข่ายของอุปกรณ์ที่เชื่อมต่อกับอินเทอร์เน็ต',
    MLOps:
      'Machine Learning Operations - แนวทางสำหรับการปล่อยและบำรุงรักษาระบบ ML',
  },
};
...
export default function Tooltip({
  ...
  const glossaryContent =
    glossary[isThai ? 'th' : 'en'][content as keyof typeof glossary.en] ||
    content;
