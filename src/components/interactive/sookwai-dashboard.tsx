      ...
      <div className="p-6 grid md:grid-cols-3 gap-6">
        ...
        >
          ...
          <div className="text-4xl font-bold text-white mb-1">
            {heartRate}{' '}
            <span className="text-lg text-text-muted font-normal">bpm</span>
          </div>
          ...
          <div className="absolute bottom-0 left-0 right-0 h-16 opacity-20">
            <svg
              viewBox="0 0 100 20"
              className="w-full h-full text-rose-500 fill-current"
            >
        ...
        >
          ...
          <div className="text-4xl font-bold text-white mb-1">
            1,240{' '}
            <span className="text-lg text-text-muted font-normal">steps</span>
          </div>
        ...
        >
          ...
          <div className="text-4xl font-bold text-white mb-1">7h 20m</div>
          <p className="text-sm text-indigo-300">Deep Sleep: 2h 15m</p>
          <div className="flex gap-1 mt-4">
            {[...Array(5)].map((_, i) => (
              <div
                key={i}
                className={`h-1 flex-1 rounded-full ${i < 4 ? 'bg-indigo-500' : 'bg-surface-3'}`}
              />
            ))}
          </div>
        </motion.div>
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="font-semibold text-green-400">
                Fall Detection System Active
              </div>
              <div className="text-xs text-green-400/60">
                Monitored area: Living Room, Bedroom
              </div>
            </div>
          </div>
