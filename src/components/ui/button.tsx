...
const buttonVariants = cva(
  'inline-flex items-center justify-center whitespace-nowrap rounded-2xl text-sm font-semibold ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50',
  {
    variants: {
      variant: {
        default: 'bg-gradient-to-tr from-cyan-400 via-blue-600 to-indigo-600 text-white hover:scale-[1.01] active:scale-[0.99]',
        destructive: 'bg-destructive text-destructive-foreground hover:bg-destructive/90',
        outline: 'border border-hairline bg-surface text-text hover:bg-surface-2 hover:text-accent-foreground',
      ...
      size: {
        ...
        lg: 'h-14 rounded-2xl px-10 py-5 text-lg',
        icon: 'h-10 w-10',
      },
    },
    defaultVariants: {
