...
export const routes = {
  ...
  register: (locale: string): Route => withBasePath('/register', locale) as Route,

  dashboard: (locale: string): Route => withBasePath('/dashboard', locale) as Route,

  faq: (locale: string): Route => withBasePath('/faq', locale) as Route,

  howWeWork: (locale: string): Route => withBasePath('/how-we-work', locale) as Route,

  careers: (locale: string): Route => withBasePath('/careers', locale) as Route,

  partners: (locale: string): Route => withBasePath('/partners', locale) as Route,
  ...
  packages: (locale: string): Route => withBasePath('/packages', locale) as Route,
  ...
  resources: (locale: string): Route => withBasePath('/resources', locale) as Route,
  ...
  solutions: (locale: string): Route => withBasePath('/solutions', locale) as Route,

  solutionDetail: (locale: string, slug: string): Route =>
    withBasePath(`/solutions/${slug}`, locale) as Route,

  industries: (locale: string): Route => withBasePath('/industries', locale) as Route,

  industryDetail: (locale: string, slug: string): Route =>
    withBasePath(`/industries/${slug}`, locale) as Route,

  products: (locale: string): Route => withBasePath('/products', locale) as Route,
  ...
  // Legal pages
  legal: {
    terms: (locale: string): Route => withBasePath('/legal/terms', locale) as Route,
    privacy: (locale: string): Route => withBasePath('/legal/privacy', locale) as Route,
    cookies: (locale: string): Route => withBasePath('/legal/cookies', locale) as Route,
    disclaimer: (locale: string): Route => withBasePath('/legal/disclaimer', locale) as Route,
    pdpa: (locale: string): Route => withBasePath('/legal/pdpa', locale) as Route,
    dsar: (locale: string): Route => withBasePath('/legal/dsar', locale) as Route,
    refund: (locale: string): Route => withBasePath('/legal/refund', locale) as Route,
  },
};
