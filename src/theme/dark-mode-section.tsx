    ...
    <section className="deep-tech-section py-24 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
         <div className="max-w-4xl mx-auto text-center mb-16">
            ...
            >
              ขับเคลื่อนด้วย AI ขั้นสูงและ Deep Learning Model ที่ถูกฝึกฝนด้วยข้อมูลเกษตรกรรมไทยกว่า 10 ปี เพื่อผลลัพธ์ที่แม่นยำที่สุด
            </motion.p>
         </div>
         ...
         <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              { title: 'Neural Networks', desc: 'จำลองโครงข่ายประสาทเพื่อวิเคราะห์โรคพืช', color: 'border-cyan-500' },
              { title: 'Satellite Imaging', desc: 'ประมวลผลภาพถ่ายดาวเทียมแบบ Real-time', color: 'border-blue-500' },
              { title: 'Predictive Analytics', desc: 'ทำนายสภาพอากาศและผลผลิตล่วงหน้า', color: 'border-indigo-500' }
            ].map((item, i) => (
              <motion.div
                key={i}
                initial={{ opacity: 0, y: 20 }}
